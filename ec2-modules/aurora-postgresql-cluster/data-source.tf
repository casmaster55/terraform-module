...
data "aws_subnet" "private_1" {
  filter {
    name   = "tag:Name"
    values = ["2555-dev-del-private-subnet-1-us-east-1a"]
  }
}
...
data "aws_subnet" "private_2" {
  filter {
    name   = "tag:Name"
    values = ["2555-dev-del-private-subnet-2-us-east-1b"]
  }
}

data "aws_secretsmanager_secret" "rds_password" {
  name = "2555-dev-del-artifactory-db-password"
}
...
data "aws_secretsmanager_secret" "rds_username" {
  name = "2555-dev-del-artifactory-db-username"
}
